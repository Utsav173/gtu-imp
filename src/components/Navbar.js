...
export default function WithSubnavigation() {
  ...
  return (
    <Box>
      <Flex
        bg={useColorModeValue("gray.100", "#090909")}
        color={useColorModeValue("#090909", "white")}
        minH={"60px"}
        py={{ base: 2 }}
        px={{ base: 4 }}
        borderBottom={1}
...
const DesktopNav = () => {
  const linkColor = useColorModeValue("gray.600", "#090909");
  const linkHoverColor = useColorModeValue("gray.800", "white");
  const popoverContentBgColor = useColorModeValue("gray.200", "#1B1B1B");
