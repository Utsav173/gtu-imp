  ...
  return (
    <Container className={`text-${props.mode === "light" ? "dark" : "light"}`}>
        <Container className='text-center'>
            ...
            <Link to="/gtuimp" className={`btn btn-outline-${props.mode === "light" ? "dark" : "light"} shadow rounded text-capitalize my-1`}>GTU IMP QUESTIONS</Link>
            ...
            <Link to="/iswapaper" className='btn btn-outline-danger text-capitalize my-1 shadow rounded'>ISWA Previous Years papers</Link>
            <Link to="/varpaper" className='btn btn-success text-capitalize my-1 shadow bg-success rounded fw-bolder' >VAR Previous Years papers</Link>
            <Link to="/cvpaper" className={`btn btn-outline-${props.mode === "light" ? "dark" : "light"} shadow rounded text-capitalize my-1`}>CV Previous Years papers</Link>
          </Nav>
        </Container>
        <Routes>
