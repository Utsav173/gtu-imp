  ...
  return (
    <Container>
        <Container className='text-center'>
            ...
            <Link to="/adudpaper" className='btn btn-outline-info text-capitalize my-1'>ADUD Previous Years papers</Link>
            <Link to="/iswapaper" className='btn btn-outline-danger text-capitalize my-1'>ISWA Previous Years papers</Link>
            <Link to="/varpaper" className='btn btn-outline-dark text-capitalize my-1'>VAR Previous Years papers</Link>
