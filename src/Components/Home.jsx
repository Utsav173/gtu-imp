  ...
  return (
    <Container className={`text-${props.mode === "light" ? "dark" : "light"}`}>
        <Container className='text-center'>
            ...
            <Link to="/gtuimp" className={`btn btn-outline-${props.mode === "light" ? "dark" : "light"} text-capitalize my-1`}>GTU IMP QUESTIONS</Link>
            ...
            <Link to="/iswapaper" className={`btn btn-outline-${props.mode === "light" ? "dark" : "light"} text-capitalize my-1`}>ISWA Previous Years papers</Link>
            <Link to="/varpaper" className='btn btn-outline-success text-capitalize my-1' >VAR Previous Years papers</Link>
            <Link to="/cvpaper" className={`btn btn-outline-${props.mode === "light" ? "dark" : "light"} text-capitalize my-1`}>CV Previous Years papers</Link>
          </Nav>
        </Container>
        <Routes>
